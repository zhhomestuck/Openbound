...
Sburb.stage.beginPath();Sburb.stage.moveTo(startX,startY+this.lineHeight-3);Sburb.stage.lineTo(startX+numCharsWidth,startY+this.lineHeight-3);Sburb.stage.closePath();Sburb.stage.stroke();}}if(linePos==-1){lenCount+=this.lines[i].length;linePos=0;offsetX=0;i++;}
Sburb.stage.restore();}}
...
Sburb.Chooser.prototype.draw=function(){if(this.choosing){Sburb.stage.save();var x,y,width=160,height=0,i;x=this.dialogs[0].x;y=this.dialogs[0].y-1;for(i=0;i<this.dialogs.length;i++){width=Math.max(width,Sburb.stage.measureText(this.dialogs[i].lines[0]).width+this.dialogs[i].charWidth);}
